...
app.MapPost("creategist", async (string code, HttpRequest req) =>
{
    ...
    {
        Description = $"Generated by ChatGPT {DateTime.UtcNow}",
    };
    ...
    return new GistResult(res.HtmlUrl, $"https://htmlpreview.github.io/?{res.HtmlUrl}/raw/file1.html");    
})
.WithName("creategist")
.WithOpenApi(gen =>
{
...
public record GistResult(string url, string htmlPreviewUrl);